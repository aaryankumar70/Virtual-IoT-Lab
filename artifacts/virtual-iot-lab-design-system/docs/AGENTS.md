# Virtual IoT Lab Design System design system
...
workspace package (`@workspace/virtual-iot-lab-design-system`): other artifacts depend
...
- `docs/references/component-inventory.md` — normalized source-backed component
  inventory extracted from Virtual IoT Lab.
- `docs/references/components/*.md` — per-family source evidence and port notes.
- `src/virtual-iot.css` — source-derived engineering surface and component geometry
  styles used by the custom preview components.
...
`@workspace/virtual-iot-lab-design-system/components/...`. Never use a `@/` alias inside
...
for `@workspace/virtual-iot-lab-design-system` and renders mockups using this package's
theme and components.

## Consuming this package

Never copy token values, component source, hooks, or these docs into a consuming
artifact. Add `@workspace/virtual-iot-lab-design-system` as a `workspace:*` dependency,
...
- Building or styling web UI: `artifacts/virtual-iot-lab-design-system/docs/consuming-web.md`
- Building or styling Expo UI: `artifacts/virtual-iot-lab-design-system/docs/consuming-expo.md`
- Building or styling a slide deck: `artifacts/virtual-iot-lab-design-system/docs/consuming-slides.md`
- Replacing an existing or scaffolded web theme/component library:
  `artifacts/virtual-iot-lab-design-system/docs/migrating-web.md`
- Replacing existing or scaffolded Expo theme/hooks/components:
  `artifacts/virtual-iot-lab-design-system/docs/migrating-expo.md`
