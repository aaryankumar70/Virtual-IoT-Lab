# Consuming Virtual IoT Lab Design System in Expo apps

Read `artifacts/virtual-iot-lab-design-system/docs/AGENTS.md` first. React Native does
...
`artifacts/virtual-iot-lab-design-system/docs/migrating-expo.md` before writing UI.
...
```tsx
import { tokens } from "@workspace/virtual-iot-lab-design-system/tokens";
...
```tsx
import { nativeTheme } from "@workspace/virtual-iot-lab-design-system/lib/native-theme";
import { useColors } from "@workspace/virtual-iot-lab-design-system/hooks/use-colors";
import { useDesignSystemFonts } from "@workspace/virtual-iot-lab-design-system/hooks/use-fonts";
```
...
```tsx
import { Badge } from "@workspace/virtual-iot-lab-design-system/components/native/badge";
import { Button } from "@workspace/virtual-iot-lab-design-system/components/native/button";
import { Card } from "@workspace/virtual-iot-lab-design-system/components/native/card";
```
...
Import and render
`@workspace/virtual-iot-lab-design-system/components/native/button`, then run Expo
