# Consuming Virtual IoT Lab Design System in web apps

Read `artifacts/virtual-iot-lab-design-system/docs/AGENTS.md` first. This guide covers
...
`artifacts/virtual-iot-lab-design-system/docs/migrating-web.md` before writing UI.
...
```css
@import "@workspace/virtual-iot-lab-design-system/styles.css";
```
...
`node_modules/@workspace/virtual-iot-lab-design-system/src/components` to `content`.
...
```tsx
import { Button } from "@workspace/virtual-iot-lab-design-system/components/ui/button";
import { cn } from "@workspace/virtual-iot-lab-design-system/lib/utils";
import {
  toast,
  useToast,
} from "@workspace/virtual-iot-lab-design-system/hooks/use-toast";
```
...
`@workspace/virtual-iot-lab-design-system/components/ui/button`. Run the app's typecheck
