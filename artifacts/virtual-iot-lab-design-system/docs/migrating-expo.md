# Migrating Expo UI to Virtual IoT Lab Design System

Read `artifacts/virtual-iot-lab-design-system/docs/AGENTS.md` and
`artifacts/virtual-iot-lab-design-system/docs/consuming-expo.md` first. Use this guide
...
- Rewrite color/theme imports to
  `@workspace/virtual-iot-lab-design-system/lib/native-theme` and
  `@workspace/virtual-iot-lab-design-system/hooks/use-colors`.
- Rewrite the root layout to use
  `@workspace/virtual-iot-lab-design-system/hooks/use-fonts` while preserving its
  SplashScreen gating.
...
and hook directly from `@workspace/virtual-iot-lab-design-system` and retains only
