# Migrating web UI to Virtual IoT Lab Design System

Read `artifacts/virtual-iot-lab-design-system/docs/AGENTS.md` and
`artifacts/virtual-iot-lab-design-system/docs/consuming-web.md` first. Use this guide
...
- `@/components/ui/<name>` →
  `@workspace/virtual-iot-lab-design-system/components/ui/<name>`
- `@/lib/utils` (`cn`) → `@workspace/virtual-iot-lab-design-system/lib/utils`
- `@/hooks/use-toast` → `@workspace/virtual-iot-lab-design-system/hooks/use-toast`
